...
//Add WIFI data
const char* ssid = "HONOR X6";              //Add your WIFI network name 
const char* password =  "arte1234";           //Add WIFI password
...
int Foco = 26;                          //Connect LED on this pin (add 150ohm resistor)
...
void setup() {
  ...
  pinMode(Foco, OUTPUT);                   //Set pin 2 as OUTPUT
...
void loop() {  
  ...
  if(Actual_Millis - Previous_Millis > refresh_time){
    ...
    if(WiFi.status()== WL_CONNECTED){                   //Check WiFi connection status  
      ...
      http.begin("http://192.168.169.142/proyecto/esp32_update.php");   //Indicate the destination webpage 
